...
import { 
  ...
  Check, Truck, RotateCcw, ShieldCheck, Star
} from 'lucide-react';
...
const ProductDetailPage =({ productId = '1' }: ProductDetailPageProps) => {
  ...
  React.useEffect(() => {
    const fetchProductData = async () => {
      ...
      if (fetchedProduct) {
        const fetchedRelatedProducts = await fetchRelatedProducts(fetchedProduct);
  ...
  return (
    <div className="container mx-auto px-4 py-16 mt-16">
      ...
      <nav className="flex items-center text-sm mb-8">
        ...
        <ChevronRight size={16} className="mx-2 text-gray-400" />
        <Link to={`/category/${Array.isArray(product.categories) ? product.categories.join('-').toLowerCase() : product.categories}`} className="text-gray-500 hover:text-gray-700">
          {Array.isArray(product.categories) ? product.categories.map((cat: string) => cat.charAt(0).toUpperCase() + cat.slice(1)).join(', ') : product.categories}
        </Link>
        <ChevronRight size={16} className="mx-2 text-gray-400" />
      ...
      <div className="flex flex-col lg:flex-row gap-10">
        ...
        <div className="lg:w-1/2">
          <div className="mb-2">
            ...
            {!product.inStock && (
              <Badge variant="danger" className="mb-2 ml-2">Out of Stock</Badge>
            )}
          </div>
          ...
          <div className="flex items-center mb-4">
            ...
            <span className="text-gray-600">{product.rating.toFixed(1)} rating</span>
          </div>
          ...
          <div className="border-t border-b border-gray-200 py-6 mb-6">
            ...
            <div className="flex flex-col sm:flex-row space-y-3 sm:space-y-0 sm:space-x-3">
              ...
              <Button
                ...
                className={isProductInWishlist ? 'bg-red-600 hover:bg-red-700' : ''}
                icon={<Heart size={20} className={isProductInWishlist ? 'fill-white' : ''} />}
              >
          ...
          <div className="flex items-center justify-between">
            <div>
              ...
              <button className="ml-2 text-gray-400 hover:text-blue-600" aria-label="Share on Facebook">
                <Share2 size={18} />
              </button>
            </div>
            ...
            <div className="flex items-center">
              ...
              <Link 
                to={`/category/${Array.isArray(product.categories) ? product.categories.join('-').toLowerCase() : product.categories}`} 
              ...
              <table className="min-w-full divide-y divide-gray-200">
                <tbody className="divide-y divide-gray-200">
                  <tr>
                    ...
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">TechMarket</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray-50">Model</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">TM-{product._id}00</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray-50">Dimensions</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">10.2 x 7.5 x 3.1 inches</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray-50">Weight</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">1.2 pounds</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray-50">Color</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">Black / White / Silver</td>
                  </tr>
                  <tr>
                    <td className="px-6 py-4 whitespace-nowrap text-sm font-medium text-gray-900 bg-gray-50">Warranty</td>
                    <td className="px-6 py-4 whitespace-nowrap text-sm text-gray-500">1 Year Limited Warranty</td>
                  </tr>
                </tbody>
              </table>
            </div>
              ...
              <div className="space-y-6">
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    <div>
                      <h4 className="font-medium">Amazing product, exceeded expectations!</h4>
                    ...
                    <span className="text-sm font-medium text-gray-600">John D.</span>
                  </div>
                  <p className="text-gray-600">
                    I've been using this for a month now and I'm extremely satisfied with the quality and performance. 
                    The battery life is impressive and the design is sleek. Would definitely recommend!
                  </p>
                </div>
                ...
                <div className="bg-white p-6 rounded-lg shadow-sm">
                  <div className="flex justify-between items-start mb-4">
                    ...
                    <span className="text-sm font-medium text-gray-600">Sarah M.</span>
                  </div>
                  <p className="text-gray-600">
                    This product offers excellent features at a competitive price point. The only minor issue I've 
                    had is with the setup process, which was a bit complicated. Otherwise, very happy with my purchase.
                  </p>
                </div>
              </div>
            </div>
